...
//Fonction d'inscription de nouveaux membres
...
//Fonction d'inscription de nouvelle machines
...
function displayInfoMember($bdd){
  //Selectionner les valeurs concernant le membre
  $id = $_GET['id'];
  ...
  //Affichage des valeurs dans un formulaire
  if($data)
  {
...
{
  //Selectionner les valeurs concernant une machine
  $id = $_GET['id'];
...
// FONCTION OPTIONNELLE --- Convertion Degré minute en Degré décimaux
